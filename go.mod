...
replace (
	...
	// branch: release/1.16
	github.com/ethereum/go-ethereum => github.com/shinzonetwork/go-ethereum v0.0.0-20250924001128-0f35c753ed94
...
require (
	...
	github.com/sourcenetwork/sourcehub v0.3.3-0.20250903164246-7fbf90348956
