...
func init() {
	file_shinzonetwork_querybalance_v1_query_proto_init()
	md_QueryBalanceRequest = File_shinzonetwork_querybalance_v1_query_proto.Messages().ByName("QueryBalanceRequest")
...
func (x *QueryBalanceRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_shinzonetwork_querybalance_v1_query_proto_msgTypes[0]
...
func (x *fastReflection_QueryBalanceRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "shinzonetwork.querybalance.v1.QueryBalanceRequest.address":
		return x.Address != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: shinzonetwork.querybalance.v1.QueryBalanceRequest"))
		}
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalanceRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryBalanceRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalanceRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryBalanceRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "shinzonetwork.querybalance.v1.QueryBalanceRequest.address":
		panic(fmt.Errorf("field address of message shinzonetwork.querybalance.v1.QueryBalanceRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: shinzonetwork.querybalance.v1.QueryBalanceRequest"))
		}
...
func (x *fastReflection_QueryBalanceRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in shinzonetwork.querybalance.v1.QueryBalanceRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_shinzonetwork_querybalance_v1_query_proto_init()
	md_QueryBalanceResponse = File_shinzonetwork_querybalance_v1_query_proto.Messages().ByName("QueryBalanceResponse")
...
func (x *QueryBalanceResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_shinzonetwork_querybalance_v1_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryBalanceResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "shinzonetwork.querybalance.v1.QueryBalanceResponse.amount":
		return x.Amount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: shinzonetwork.querybalance.v1.QueryBalanceResponse"))
		}
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalanceResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryBalanceResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalanceResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryBalanceResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "shinzonetwork.querybalance.v1.QueryBalanceResponse.amount":
		panic(fmt.Errorf("field amount of message shinzonetwork.querybalance.v1.QueryBalanceResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: shinzonetwork.querybalance.v1.QueryBalanceResponse"))
		}
...
func (x *fastReflection_QueryBalanceResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in shinzonetwork.querybalance.v1.QueryBalanceResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_shinzonetwork_querybalance_v1_query_proto_init()
	md_QueryBalancesRequest = File_shinzonetwork_querybalance_v1_query_proto.Messages().ByName("QueryBalancesRequest")
...
func (x *QueryBalancesRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_shinzonetwork_querybalance_v1_query_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryBalancesRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "shinzonetwork.querybalance.v1.QueryBalancesRequest.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: shinzonetwork.querybalance.v1.QueryBalancesRequest"))
		}
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalancesRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryBalancesRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalancesRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryBalancesRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in shinzonetwork.querybalance.v1.QueryBalancesRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *_QueryBalancesResponse_1_list) Set(i int, value protoreflect.Value) {
	...
	concreteValue := valueUnwrapped.Interface().(*QueryBalance)
...
func init() {
	file_shinzonetwork_querybalance_v1_query_proto_init()
	md_QueryBalancesResponse = File_shinzonetwork_querybalance_v1_query_proto.Messages().ByName("QueryBalancesResponse")
...
func (x *QueryBalancesResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_shinzonetwork_querybalance_v1_query_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryBalancesResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "shinzonetwork.querybalance.v1.QueryBalancesResponse.balances":
		return len(x.Balances) != 0
	case "shinzonetwork.querybalance.v1.QueryBalancesResponse.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: shinzonetwork.querybalance.v1.QueryBalancesResponse"))
		}
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalancesResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryBalancesResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message shinzonetwork.querybalance.v1.QueryBalancesResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryBalancesResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in shinzonetwork.querybalance.v1.QueryBalancesResponse", d.FullName()))
	}
	panic("unreachable")
}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.Balances = append(x.Balances, &QueryBalance{})
...
func (*QueryBalanceRequest) Descriptor() ([]byte, []int) {
	return file_shinzonetwork_querybalance_v1_query_proto_rawDescGZIP(), []int{0}
}
...
func (*QueryBalanceResponse) Descriptor() ([]byte, []int) {
	return file_shinzonetwork_querybalance_v1_query_proto_rawDescGZIP(), []int{1}
}
...
func (*QueryBalancesRequest) Descriptor() ([]byte, []int) {
	return file_shinzonetwork_querybalance_v1_query_proto_rawDescGZIP(), []int{2}
}
...
func (*QueryBalancesResponse) Descriptor() ([]byte, []int) {
	return file_shinzonetwork_querybalance_v1_query_proto_rawDescGZIP(), []int{3}
}

func (x *QueryBalancesResponse) GetBalances() []*QueryBalance {
	if x != nil {
		return x.Balances
	}
	return nil
...
var File_shinzonetwork_querybalance_v1_query_proto protoreflect.FileDescriptor

var file_shinzonetwork_querybalance_v1_query_proto_rawDesc = []byte{
	0x0a, 0x29, 0x73, 0x68, 0x69, 0x6e, 0x7a, 0x6f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f,
	0x71, 0x75, 0x65, 0x72, 0x79, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x2f,
	0x71, 0x75, 0x65, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1d, 0x73, 0x68, 0x69,
	0x6e, 0x7a, 0x6f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x71, 0x75, 0x65, 0x72, 0x79,
	...
	0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x30, 0x73, 0x68, 0x69, 0x6e,
	0x7a, 0x6f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x62,
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x62,
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2f, 0x0a, 0x13,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x5e, 0x0a,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4d, 0x0a, 0x08, 0x62, 0x61, 0x6c, 0x61, 0x6e,
	0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x73, 0x68, 0x69, 0x6e,
	0x7a, 0x6f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x71, 0x75, 0x65, 0x72, 0x79, 0x62,
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x42,
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x08, 0x62, 0x61,
	...
	,
	...
	,
}

var (
	file_shinzonetwork_querybalance_v1_query_proto_rawDescOnce sync.Once
	file_shinzonetwork_querybalance_v1_query_proto_rawDescData = file_shinzonetwork_querybalance_v1_query_proto_rawDesc
)

func file_shinzonetwork_querybalance_v1_query_proto_rawDescGZIP() []byte {
	file_shinzonetwork_querybalance_v1_query_proto_rawDescOnce.Do(func() {
		file_shinzonetwork_querybalance_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_shinzonetwork_querybalance_v1_query_proto_rawDescData)
	})
	return file_shinzonetwork_querybalance_v1_query_proto_rawDescData
}

var file_shinzonetwork_querybalance_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_shinzonetwork_querybalance_v1_query_proto_goTypes = []interface{}{
	(*QueryBalanceRequest)(nil),   // 0: shinzonetwork.querybalance.v1.QueryBalanceRequest
	(*QueryBalanceResponse)(nil),  // 1: shinzonetwork.querybalance.v1.QueryBalanceResponse
	(*QueryBalancesRequest)(nil),  // 2: shinzonetwork.querybalance.v1.QueryBalancesRequest
	(*QueryBalancesResponse)(nil), // 3: shinzonetwork.querybalance.v1.QueryBalancesResponse
	(*v1beta1.PageRequest)(nil),   // 4: cosmos.base.query.v1beta1.PageRequest
	(*QueryBalance)(nil),          // 5: shinzonetwork.querybalance.v1.QueryBalance
	(*v1beta1.PageResponse)(nil),  // 6: cosmos.base.query.v1beta1.PageResponse
}
var file_shinzonetwork_querybalance_v1_query_proto_depIdxs = []int32{
	4, // 0: shinzonetwork.querybalance.v1.QueryBalancesRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	5, // 1: shinzonetwork.querybalance.v1.QueryBalancesResponse.balances:type_name -> shinzonetwork.querybalance.v1.QueryBalance
	6, // 2: shinzonetwork.querybalance.v1.QueryBalancesResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	0, // 3: shinzonetwork.querybalance.v1.Query.Balance:input_type -> shinzonetwork.querybalance.v1.QueryBalanceRequest
	2, // 4: shinzonetwork.querybalance.v1.Query.Balances:input_type -> shinzonetwork.querybalance.v1.QueryBalancesRequest
	1, // 5: shinzonetwork.querybalance.v1.Query.Balance:output_type -> shinzonetwork.querybalance.v1.QueryBalanceResponse
	3, // 6: shinzonetwork.querybalance.v1.Query.Balances:output_type -> shinzonetwork.querybalance.v1.QueryBalancesResponse
...
func init() { file_shinzonetwork_querybalance_v1_query_proto_init() }
func file_shinzonetwork_querybalance_v1_query_proto_init() {
	if File_shinzonetwork_querybalance_v1_query_proto != nil {
		return
	}
	file_shinzonetwork_querybalance_v1_querybalance_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_shinzonetwork_querybalance_v1_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shinzonetwork_querybalance_v1_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shinzonetwork_querybalance_v1_query_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shinzonetwork_querybalance_v1_query_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_shinzonetwork_querybalance_v1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_shinzonetwork_querybalance_v1_query_proto_goTypes,
		DependencyIndexes: file_shinzonetwork_querybalance_v1_query_proto_depIdxs,
		MessageInfos:      file_shinzonetwork_querybalance_v1_query_proto_msgTypes,
	}.Build()
	File_shinzonetwork_querybalance_v1_query_proto = out.File
	file_shinzonetwork_querybalance_v1_query_proto_rawDesc = nil
	file_shinzonetwork_querybalance_v1_query_proto_goTypes = nil
	file_shinzonetwork_querybalance_v1_query_proto_depIdxs = nil
}
