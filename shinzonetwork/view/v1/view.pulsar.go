...
func (x *fastReflection_View) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ContractAddress != "" {
		...
		if !f(fd_View_contract_address, value) {
			return
		}
	}
	if len(x.Data) != 0 {
...
func (x *fastReflection_View) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "shinzonetwork.view.v1.View.creator":
		return x.Creator != ""
	case "shinzonetwork.view.v1.View.contract_address":
...
func (x *fastReflection_View) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "shinzonetwork.view.v1.View.contract_address":
		panic(fmt.Errorf("field contract_address of message shinzonetwork.view.v1.View is not mutable"))
	case "shinzonetwork.view.v1.View.data":
...
func (x *View) GetContractAddress() string {
	if x != nil {
		return x.ContractAddress
	}
	return ""
