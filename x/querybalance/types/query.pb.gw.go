...
var (
	pattern_Query_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"shinzonetwork", "querybalance", "v1", "balance", "address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Balances_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"shinzonetwork", "querybalance", "v1", "balances"}, "", runtime.AssumeColonVerbOpt(false)))
)
